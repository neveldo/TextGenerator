...
class ChooseFunctionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $result = $this->function->execute(['3', 'test1','test2', 'test3']);
        $this->assertEquals('test3', $result);
    }

    public function testChooseWithUnexistantArg()
    {
        $result = $this->function->execute([0, 'test1','test2', 'test3']);
        $this->assertEquals('', $result);
    }

    public function testChooseWithUnexistantArg2()
    {
        $result = $this->function->execute([7, 'test1','test2', 'test3']);
        $this->assertEquals('', $result);
    }
}